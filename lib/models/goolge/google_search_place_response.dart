class GoogleSearchPlaceResponse {
  PlusCode? plusCode;
  List<Results>? results;
  String? status;

  GoogleSearchPlaceResponse({this.plusCode, this.results, this.status});

  GoogleSearchPlaceResponse.fromJson(Map<String, dynamic> json) {
