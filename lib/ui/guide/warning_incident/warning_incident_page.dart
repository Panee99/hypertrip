...
import 'package:room_finder_flutter/ui/guide/warning_incident/components/rf_warning_incident_item.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => GetIt.I.get<WarningIncidentBloc>()
        ..add(const FetchDataWeather())
        ..add(const FetchDataEarthQuakes()),
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Warning for incident'),
          centerTitle: true,
          ...
          builder: (context, state) {
            return ListView(
              ...
              children: [
                ...
                if (state is WeatherLoadingState) const Center(child: CircularProgressIndicator()),
