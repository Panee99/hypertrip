        ...
        if (widget.title != null && widget.title!.isNotEmpty)
          Padding(
            ...
            child: RichText(
              text: TextSpan(
                text: widget.title,
                style: boldTextStyle(size: 16, color: appTextColorPrimary),
              ),
            ),
          ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                cursorColor: appTextColorPrimary,
                inputFormatters: widget.inputFormatters,
                style: widget.style ?? primaryTextStyle(size: 14, color: appTextColorPrimary),
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle:
                      widget.hintStyle ?? primaryTextStyle(size: 14, color: appTextColorPrimary),
                  ...
                  focusedBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                      color: widget.readOnly
                          ? Colors.grey
                          : (widget.errorText.isNotEmpty ? Colors.red : rf_primaryColor),
                    ),
                  ),
